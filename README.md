...
- [@oiap/exporter-antigravity](packages/exporter-antigravity) exports OIAP plugins into Google Antigravity workspace bundle artifacts.
...
- [@oiap/exporter-cursor](packages/exporter-cursor) exports OIAP plugins into Cursor plugin artifacts.
