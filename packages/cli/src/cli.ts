...
const generalHelpText = `Usage:
	oiap build <plugin-file> [--target all|antigravity|claude-code|cline|codex|cursor|gemini-cli|openclaw|opencode|vscode-copilot-chat] [--out <dir>] [--export <name>] [--json]
  oiap targets [--json]
